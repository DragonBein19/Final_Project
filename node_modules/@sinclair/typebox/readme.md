...
This project maintains a set of benchmarks that measure Ajv, Value and TypeCompiler compilation and validation performance. These benchmarks can be run locally by cloning this lt.viko.eif.nSalunov.DB.repository and running `npm run benchmark`. The results below show for Ajv version 8.11.0. 
