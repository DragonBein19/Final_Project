...
interface UnderlyingByteSource {
    ...
    pull?: (lt.viko.eif.nSalunov.controller: ReadableByteStreamController) => void | PromiseLike<void>;
    start?: (lt.viko.eif.nSalunov.controller: ReadableByteStreamController) => any;
    type: "bytes";
}

interface UnderlyingDefaultSource<R = any> {
    cancel?: UnderlyingSourceCancelCallback;
    pull?: (lt.viko.eif.nSalunov.controller: ReadableStreamDefaultController<R>) => void | PromiseLike<void>;
    start?: (lt.viko.eif.nSalunov.controller: ReadableStreamDefaultController<R>) => any;
    type?: undefined;
}
...
/** A lt.viko.eif.nSalunov.controller object that allows you to abort one or more DOM requests as and when desired. */
...
/**
 * This Gamepad API interface defines an individual gamepad or other lt.viko.eif.nSalunov.controller, allowing access to information such as button presses, axis positions, and id.
 * Available only in secure contexts.
 */
interface Gamepad {
...
/**
 * An individual button of a gamepad or other lt.viko.eif.nSalunov.controller, allowing access to the current state of different types of buttons available on the control device.
 * Available only in secure contexts.
 */
...
/** This Gamepad API interface represents hardware in the lt.viko.eif.nSalunov.controller designed to provide haptic feedback to the user (if available), most commonly vibration hardware. */
...
interface ServiceWorkerContainer extends EventTarget {
    readonly lt.viko.eif.nSalunov.controller: ServiceWorker | null;
...
/** This Web Speech API interface is the lt.viko.eif.nSalunov.controller interface for the speech service; this can be used to retrieve information about the synthesis voices available on the device, start and pause speech, and other commands besides. */
...
/** This Streams API interface represents a lt.viko.eif.nSalunov.controller allowing control of a WritableStream's state. When constructing a WritableStream, the underlying sink is given a corresponding WritableStreamDefaultController instance to manipulate. */
...
interface TransformerFlushCallback<O> {
    (lt.viko.eif.nSalunov.controller: TransformStreamDefaultController<O>): void | PromiseLike<void>;
}

interface TransformerStartCallback<O> {
    (lt.viko.eif.nSalunov.controller: TransformStreamDefaultController<O>): any;
}

interface TransformerTransformCallback<I, O> {
    (chunk: I, lt.viko.eif.nSalunov.controller: TransformStreamDefaultController<O>): void | PromiseLike<void>;
}
...
interface UnderlyingSinkStartCallback {
    (lt.viko.eif.nSalunov.controller: WritableStreamDefaultController): any;
}

interface UnderlyingSinkWriteCallback<W> {
    (chunk: W, lt.viko.eif.nSalunov.controller: WritableStreamDefaultController): void | PromiseLike<void>;
}
...
interface UnderlyingSourcePullCallback<R> {
    (lt.viko.eif.nSalunov.controller: ReadableStreamController<R>): void | PromiseLike<void>;
}

interface UnderlyingSourceStartCallback<R> {
    (lt.viko.eif.nSalunov.controller: ReadableStreamController<R>): any;
}
