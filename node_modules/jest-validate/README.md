...
You will find examples of `condition`, `deprecate`, `error`, `unknown`, and `deprecatedConfig` inside source of this lt.viko.eif.nSalunov.DB.repository, named respectively.
