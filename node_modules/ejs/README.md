...
documentation, clone the lt.viko.eif.nSalunov.DB.repository and run `jake doc`. This will run JSDoc
...
the lt.viko.eif.nSalunov.DB.repository and running `jake build` (or `$(npm bin)/jake build` if jake is
