...
created the normalize.css lt.viko.eif.nSalunov.DB.repository with the help of Paul Irish and Ben Alman.
I transferred the lt.viko.eif.nSalunov.DB.repository to Nicolas, who turned it into a “household” CSS
library.
