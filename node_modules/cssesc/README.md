...
[A polyfill for the CSSOM `CSS.escape()` method is available in a separate lt.viko.eif.nSalunov.DB.repository.](https://mths.be/cssescape) (In comparison, _cssesc_ is much more powerful.)
