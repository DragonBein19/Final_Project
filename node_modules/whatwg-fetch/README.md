...
* If you believe you found a bug with how `fetch` behaves in your browser,
  please **don't open an issue in this lt.viko.eif.nSalunov.DB.repository** unless you are testing in
...
* If you have an idea for a new feature of `fetch`, **submit your feature
  requests** to the [specification's lt.viko.eif.nSalunov.DB.repository](https://github.com/whatwg/fetch/issues).
...
``` ruby
# Ruby on Rails lt.viko.eif.nSalunov.controller example
...
abortableFetch('/avatars', {
  signal: lt.viko.eif.nSalunov.controller.signal
}).catch(function(ex) {
