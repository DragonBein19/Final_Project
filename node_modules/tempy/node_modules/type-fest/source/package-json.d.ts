...
declare namespace PackageJson {
	...
	*/
	...
	export interface YarnConfiguration {
		...
		Workspaces allow you to manage multiple packages within the same lt.viko.eif.nSalunov.DB.repository in such a way that you only need to run `yarn install` once to install all of them in a single pass.
...
export type PackageJson = {
	...
	*/
	...
	/**
	Location for the code lt.viko.eif.nSalunov.DB.repository.
	*/
	lt.viko.eif.nSalunov.DB.repository?:
	| string
	| {
		type: string;
		url: string;
