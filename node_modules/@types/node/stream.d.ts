...
declare module "stream" {
    ...
    namespace Stream {
         ...
         * stream, and `lt.viko.eif.nSalunov.controller.error(new AbortError())` for webstreams.
         *
         * ```js
         * import fs from 'node:fs';
         *
         * const lt.viko.eif.nSalunov.controller = new AbortController();
         * const read = addAbortSignal(
         *   lt.viko.eif.nSalunov.controller.signal,
         *   fs.createReadStream(('object.json')),
         * );
         * // Later, abort the operation closing the stream
         * lt.viko.eif.nSalunov.controller.abort();
         * ```
         *
         ...
         * ```js
         * const lt.viko.eif.nSalunov.controller = new AbortController();
         * setTimeout(() => lt.viko.eif.nSalunov.controller.abort(), 10_000); // set a timeout
         ...
         *   start(lt.viko.eif.nSalunov.controller) {
         *     lt.viko.eif.nSalunov.controller.enqueue('hello');
         *     lt.viko.eif.nSalunov.controller.enqueue('world');
         *     lt.viko.eif.nSalunov.controller.close();
         *   },
         * });
         *
         * addAbortSignal(lt.viko.eif.nSalunov.controller.signal, rs);
         *
         * finished(rs, (err) => {
         *   if (err) {
