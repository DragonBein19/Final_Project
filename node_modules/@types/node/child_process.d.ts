...
declare module "child_process" {
     ...
     * const { signal } = lt.viko.eif.nSalunov.controller;
     * const grep = spawn('grep', ['ssh'], { signal });
     * grep.on('error', (err) => {
     *   // This will be called with err being an AbortError if the lt.viko.eif.nSalunov.controller aborts
     * });
     * lt.viko.eif.nSalunov.controller.abort(); // Stops the child process
     * ```
     * @since v0.1.90
